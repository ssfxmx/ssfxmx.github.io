...
-- =============================================================================
-- Archivo de conveniencia: son las 11 migraciones concatenadas EN ORDEN.
-- Pégalo completo en el SQL Editor de Supabase y pulsa RUN una sola vez.
--
-- La fuente de verdad sigue siendo la carpeta migrations/ + seed.sql. Este
-- archivo se regenera a partir de ellos; no lo edites a mano.
--
-- Verificado contra PostgreSQL 16 antes de entregarse.
-- =============================================================================
...
-- Fin del esquema. Ejecuta las consultas de verificación del bloque 4.1 de la guía.
